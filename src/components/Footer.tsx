      ...
      <div className="mx-auto flex flex-col md:flex-row justify-between gap-8">
        ...
        <div className="flex-1 flex flex-col gap-3">
          ...
          <div className="text-[11px] leading-5 space-y-1">
            <p className="mt-1 text-[12px] leading-normal max-w-xl">
            ...
            <p className="mt-3 text-[12px] pt-2">
        ...
        {/* 정책 및 고객지원 링크 */}
        <div className="flex flex-wrap gap-x-12 gap-y-4 shrink-0 text-xs font-semibold">

          {/* 1열: 정책 */}
          <div className="flex flex-col gap-2">
            <span className={`text-[10px] uppercase tracking-widest mb-1 opacity-50 ${isDark ? 'text-white' : 'text-[#121316]'}`}>정책</span>
          ...
          {/* 3열: 고객지원 */}
          <div className="flex flex-col gap-2">
            <span className={`text-[10px] uppercase tracking-widest mb-1 opacity-50 ${isDark ? 'text-white' : 'text-[#121316]'}`}>지원</span>
            ...
            <Link to="/signup" className="hover:text-[#5E6AD2] transition-colors">시작하기</Link>
            <a href="#features" className="hover:text-[#5E6AD2] transition-colors">기능 소개</a>
          </div>
